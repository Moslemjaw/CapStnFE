...
type ResearcherDashboardScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'ResearcherDashboard'
>;

interface ResearcherDashboardScreenProps {
  navigation: ResearcherDashboardScreenNavigationProp;
}

export const ResearcherDashboardScreen: React.FC<ResearcherDashboardScreenProps> = ({ navigation }) => {
      ...
      >
        ...
        <View style={styles.bottomTabBar}>
          <TouchableOpacity style={styles.tabItem}>
            <Ionicons name="home" size={24} color={RESEARCHER_COLOR} />
