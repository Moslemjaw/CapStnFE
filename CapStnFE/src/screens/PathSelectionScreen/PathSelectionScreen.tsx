...
type PathSelectionScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'PathSelection'
>;

interface PathSelectionScreenProps {
  navigation: PathSelectionScreenNavigationProp;
}

export const PathSelectionScreen: React.FC<PathSelectionScreenProps> = ({ navigation }) => {
