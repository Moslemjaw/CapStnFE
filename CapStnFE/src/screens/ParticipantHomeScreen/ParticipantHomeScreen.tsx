...
type ParticipantHomeScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'ParticipantHome'
>;

interface ParticipantHomeScreenProps {
  navigation: ParticipantHomeScreenNavigationProp;
}

export const ParticipantHomeScreen: React.FC<ParticipantHomeScreenProps> = ({ navigation }) => {
